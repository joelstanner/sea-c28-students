...
class AboutComprehension(Koan):
    ...
    def test_unpacking_tuples_in_list_comprehensions(self):
        ...
        self.assertEqual('spamspamspamspam', len(comprehension[2]))
    ...
    def test_creating_a_set_with_set_comprehension(self):
        ...
        self.assertEqual({'a', 'b', 'c'}, comprehension)
        # rememeber that set members are unique
    ...
    def test_creating_a_dictionary_with_dictionary_comprehension(self):
        ...
        dict_comprehension = {k.upper(): weapon for k, weapon in
                              dict_of_weapons.iteritems() if weapon}

        self.assertEqual('KeyError', 'first' in dict_comprehension)
        self.assertEqual('fear', 'FIRST' in dict_comprehension)
        self.assertEqual(5, len(dict_of_weapons))
        self.assertEqual(5, len(dict_comprehension))
